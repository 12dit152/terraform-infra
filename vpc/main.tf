variable "private_subnet_flow_log_allow_arn" { type = string }
variable "private_subnet_flow_log_deny_arn" { type = string }
variable "public_subnet_flow_log_allow_arn" { type = string }
variable "public_subnet_flow_log_deny_arn" { type = string }
variable "vpc_flow_logs_role_arn" { type = string }
